...
<script src="<?= base_url('dist/js/adminlte.min.js?v=' . (file_exists(FCPATH . 'dist/js/adminlte.min.js') ? filemtime(FCPATH . 'dist/js/adminlte.min.js') : '')) ?>"></script>

<!--begin::Main com Versioning-->
<script src="<?= base_url('dist/js/main.min.js?v=' . (file_exists(FCPATH . 'dist/js/main.min.js') ? filemtime(FCPATH . 'dist/js/main.min.js') : '')) ?>"></script>
...
<script>
    ...
    $perfMonitorPath = FCPATH . 'public/dist/js/performance-monitor.min.js';
...
<script>
    ...
    function invalidateCache(urlPattern) {
        ...
        const keys = Object.keys(sessionStorage).filter(k => 
            k.startsWith('ordo_') && k.includes(urlPattern)
        );
